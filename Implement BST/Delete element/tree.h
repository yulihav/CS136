...
/* A10p4 -- delete the element e from t, by promoting the right
subtree of the subtree rooted at e, and inserting the left 
subtree into it.  By contrast, the provided function delete
promotes the left subtree.  O(height(t)) time. */
